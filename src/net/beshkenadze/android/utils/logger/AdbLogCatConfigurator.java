 ...
 */
public class AdbLogCatConfigurator {
	 ...
	 */
	public AdbLogCatConfigurator(final String fileName) {
	 ...
	 */
	public AdbLogCatConfigurator(final String fileName, final Level rootLevel) {
		this(fileName);
	 ...
	 *            If true, LogCatAppender will be used for logging
	 */
